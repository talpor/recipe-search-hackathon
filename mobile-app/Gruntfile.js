// Generated on 2014-09-01 using generator-ionic 0.5.3
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    // Environment Variables for Angular App using ng-constant
    // This creates an Angular Module that can be injected via `settings`.
    ngconstant: {
      options: {
        space: '  ',
        wrap: '"use strict";\n\n'+
              ...
              '{%= __ngModule %}',
        name: 'settings',
        dest: '<%= yeoman.app %>/scripts/settings.js',
        constants: '<%= yeoman.app %>/scripts/settings/common.json'
      },
      development: {
        constants: '<%= yeoman.app %>/scripts/settings/local.json'
      },
      staging: {
        constants: '<%= yeoman.app %>/scripts/settings/staging.json'
      },
      production: {
        constants: '<%= yeoman.app %>/scripts/settings/production.json'
      }
    },
    ...
    watch: {
      settings: {
        files: ['<%= yeoman.app %>/scripts/settings/*.json'],
      ...
      livereload: {
        ...
        files: [
          ...
          '<%= yeoman.app %>/styles/ionic.app/*.scss',
    ...
    jshint: {
      options: {
        ignores: [
          '<%= yeoman.app %>/scripts/settings.js',
