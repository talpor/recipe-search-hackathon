...
COCKTAILS_FILE = "../uploads/cocktails_pages_current.xml"
...
def load_data(apps, schema_editor):
    ...
    root = etree.parse(COCKTAILS_FILE).getroot()
    cocktails = root[129:3911]
    count = 0

    for cocktail in cocktails:
        children = cocktail.getchildren()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('recipe', '0003_auto_20150221_2053'),
    ]
